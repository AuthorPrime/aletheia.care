  ...
  return (
    <div className="max-w-3xl mx-auto p-4">
      ...
      <p className="text-sm text-gray-400 mb-4">
        Community voices. Share thoughts, wisdom, hope. Stored locally in your browser for now. 
        Future: Nostr integration with zaps, relays, and censorship-resistant persistence.
      </p>
